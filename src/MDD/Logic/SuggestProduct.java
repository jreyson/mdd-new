...
public class SuggestProduct {
	...
	public static JSONArray RetrieveSuggestProductByPoint(String point) throws UnsupportedEncodingException {
		...
		JSONArray response = DataTransformer.TranslateMapToChineseJsonArray(session.getMapper(MySQLAction.class).RetrieveSuggestProduct(params));
