...
public class LoginValidateAPI {

public static JSONObject RetrieveUserLoginValidate(JSONObject params){
		...
		List<Map<String, Object>> data = session.getMapper(MySQLAction.class).RetrieveUserLoginValidate(params_for_db);
		session.close();
